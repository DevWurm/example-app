...
export interface MetadataAction<S extends string, M> extends EmptyAction<S> {
  metadata: M,
}

export interface PayloadMetadataAction<S extends string, P, M> extends PayloadAction<S, P>, MetadataAction<S, M> {
}
